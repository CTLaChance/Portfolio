...
import { MeshBuilder, AudioEngine } from 'babylonjs';
...
class Visualizer extends React.Component {
    ...
    componentDidMount() {
        ...
        let createScene = function () {
            ...
            let music = new BABYLON.Sound("music", "/assets/fp-lesalpx.mp3", scene, null, { loop: false, autoplay: true, streaming: true });
            ...
            // Add mesh.
            let mesh = MeshBuilder.CreateIcoSphere("mesh", { radius: 5, subdivisions: 15 }, scene);
